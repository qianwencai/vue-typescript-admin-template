<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="CustPO" align="left">
        <template slot-scope="scope">
    ...
    <el-dialog :title="textMap[dialogStatus]" width="700px" :visible.sync="dialogFormVisible">
      ...
      >
        <el-form-item label="客户方订单号" prop="poNumber">
          <el-input v-model="customerModel.poNumber" />
        </el-form-item>
        <el-form-item label="金额" prop="poAmount">
          <el-input v-model="customerModel.poAmount" type="number" />
        </el-form-item>
        <el-form-item label="备注" prop="poDescription">
